            ...
            case 3: // Pesquisar membro por nome.
                if(OpçãoUsuario==3){
                    ...
                    String SearchMembro = in.nextLine();
                       System.out.println("O membro se encontra na posição "+CadastroMembro.ProcuraMembro(SearchMembro)+" do vetor"); 
                }
            break;
            case 4: // Incluir bicicleta.
                if(OpçãoUsuario==4){
                    ...
                    boolean adicionado = (CadastroBicicleta.adicionaBicicleta(Bicicleta1));
                          if (adicionado == true) {
                              System.out.println("*Bicicleta Cadastrado!*");
                          } else {
            ...
            case 6: // Pesquisar bicicleta por modelo.
                if(OpçãoUsuario==6){
                    ...
                    String SearchModel_bici = in.nextLine();
                       System.out.println("Este modelo de bicicleta encontra-se na posição "+CadastroBicicleta.buscaBicicletaPeloModelo(SearchModel_bici)+" do vetor"); 
                }
            break;
